...
const STRINGS = {
  ...
  "compress-pdf": {
    how: { nl: "Hoe", en: "How" },
    modeClean: { nl: "Netjes", en: "Clean" },
    modeRaster: { nl: "Zwaar", en: "Heavy" },
    cleanExplains: {
      nl: "Het bestand wordt opnieuw opgeslagen: de structuur wordt strak ingepakt en wat nergens meer voor gebruikt wordt gaat eruit. Aan de pagina's zelf verandert niets — tekst blijft tekst, scherpte blijft scherpte.",
      en: "The file is re-saved: the structure is packed tightly and anything no longer used is dropped. Nothing about the pages themselves changes — text stays text, sharpness stays sharpness.",
    },
    rasterExplains: {
      nl: "Elke pagina wordt opnieuw getekend als afbeelding. Dat maakt een scan vaak vele malen kleiner, maar de tekst is daarna geen tekst meer: niet meer te selecteren, te zoeken of te kopiëren.",
      en: "Every page is redrawn as a picture. That often makes a scan many times smaller, but the text stops being text afterwards: no longer selectable, searchable or copyable.",
    },
    ...
    smaller: { nl: "{pct}% kleiner — van {was} naar {now}.", en: "{pct}% smaller — from {was} to {now}." },
    alreadyTight: {
      nl: "Deze PDF zat al strak in elkaar; netjes opnieuw opslaan levert hier niets op. De zware manier zou wel schelen.",
      en: "This PDF was already packed tightly; re-saving it cleanly gains nothing here. The heavy way would.",
    },
    noGain: {
      nl: "Zo wordt hij niet kleiner ({now}). Bij een PDF die vooral uit tekst bestaat is opnieuw tekenen juist duurder — hou het dan bij netjes.",
      en: "It does not get smaller this way ({now}). For a PDF that is mostly text, redrawing costs more than it saves — keep it clean instead.",
    },
    pages: { nl: "Pagina's", en: "Pages" },
  },
