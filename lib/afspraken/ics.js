...
function icsStamp(ms, allDay) {
  ...
  // An all-day value is a calendar date, not an instant. It was read as local
  // midnight, so it has to be written back off the local clock — reading it in
  // UTC moves it a day earlier for everyone east of Greenwich.
  if (allDay) {
